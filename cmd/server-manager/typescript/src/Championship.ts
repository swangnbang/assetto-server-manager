        ...
        if (valString.length == 17) {
          $.ajax({
            ...
            if (response.acsr_driver_rating == null) {
              ...
              notFoundSpan.text(
                "Sorry, we couldn't find an ACSR driver matching that GUID." +
                  " You can sign up for an account ",
              );

              notFoundLink.attr(
                "href",
                "https://acsr.assettocorsaservers.com/",
              );
          ...
          incorrectGUIDSpan.text(
            "It looks like your Steam GUID is not formatted correctly! Please enter " +
